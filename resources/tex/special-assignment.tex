...
\begin{itemize}
	\item \textbf{GitHub} issues or a project board to help you organise and prioritise your development work. The course lecturer needs to see consistent use of \textbf{GitHub} issues or the project board for the duration of the assessment.
