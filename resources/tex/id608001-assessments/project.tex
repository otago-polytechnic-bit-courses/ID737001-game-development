...
In this \textbf{individual} assessment, you will design and develop \textbf{two applications} using a game engine of your choice. In addition, marks will be allocated for Git usage.
...
\subsection*{Two Games - Learning Outcomes 1 and 2 (70\%)}
\begin{itemize} 
  \item Design and develop applications using a game engine of your choice.
  \item The topic for the applications is your choice.  
  \item The applications need to open without code or file structure.
  \item Gather requirements for your applications and construct them into user stories.
  \item Integrate a database of your choice into your applications.
\end{itemize}

\subsection*{Design Document - Learning Outcomes 1 and 2 (20\%)}
...
\textbf{Note:} This is an ongoing document that you will update as you progress through the development of your applications.

\subsection*{Git Usage - Learning Outcome 1 (10\%)}
\begin{itemize}
