...
\begin{itemize}
	...
	\item A main menu that allows the user to start the game, change the game's settings, view the high scores and exit the game.
	\item In the game settings, the user can change the following:
	\begin{itemize}
    \item Sound effects volume
    \item Music volume
    \item Controls
  \end{itemize}
  \item The high scores are saved to a file and the top five scores are displayed in the main menu.
\end{itemize}

\subsection*{Code Quality and Best Practices - Learning Outcome 1 (35\%)}
\begin{itemize}
...
\subsection*{Documentation - Learning Outcome 1 (15\%)}
\begin{itemize}
	...
	\item A game design document that outlines the following:
	\begin{itemize}
    \item Overview and concept of the game. 
    \item Gameplay mechanics
    \item Story and narrative
    \item Level design
    \item Art and audio
    \item User interface and user experience
    \item Progression and rewards
  \end{itemize}
\end{itemize} 
