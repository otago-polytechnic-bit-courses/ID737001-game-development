...
\begin{itemize}
	\item Group:
	\begin{itemize}
		\item The application needs to open without code or file structure modification in \textbf{Unity}.
		...
		\item Publish the game on \textbf{itch.io}.
	\end{itemize}
	\item Individual:
	\begin{itemize}
		\item Contribute a meaningful amount of code to the client project. This will be judged by the number of \textbf{Git commits} and the number of lines of code contributed.
		...
		\item Communicate with team members. This should be through \textbf{Microsoft Teams}. If you wish to use another communication tool, you need to get approval from the course lecturer.
	\end{itemize}
\end{itemize}
...
\subsection*{Documentation and Git Usage (Individual) - Learning Outcome 1 (20\%)}
\begin{itemize}
	...
	\end{itemize}
	\item In a \textbf{Microsoft Word} document called \textbf{game-document}, include the following:
	\begin{itemize}
		\item Core concept
		\item Design pillars
	...
	\end{itemize}
	\item In a \textbf{Microsoft Word} document called \textbf{reflections}, include the following:
	\begin{itemize}
		\item Select two interesting game mechanics that you implemented in your game and explain the following:
		\begin{itemize}
